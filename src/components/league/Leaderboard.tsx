...
export function Leaderboard({ entries, currentWeek, userId }: Props) {
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-turf-500 flex items-center gap-2 mt-0.5">
                  <span>{entry.roster.length} teams</span>
                  {entry.bonus_points > 0 && (
                    <span className="text-amber-500">+{entry.bonus_points} bonus</span>
                  )}
